                        ...
                        child: Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Expanded(
                                child: Text(
                                  '${widget.recipe['ingredients'][i]['amount']['metric']['value']} ${widget.recipe['ingredients'][i]['amount']['metric']['unit']} ${widget.recipe['ingredients'][i]['name']}',
                                  style: const TextStyle(
                                    color: Color.fromARGB(255, 255, 255, 255),
                                    fontSize: 14,
                                    fontFamily: 'Poppins',
                              ...
                              if (i + 1 < widget.recipe['ingredients'].length)
                                Expanded(
                                  child: Text(
                                    '${widget.recipe['ingredients'][i + 1]['amount']['metric']['value']} ${widget.recipe['ingredients'][i + 1]['amount']['metric']['unit']} ${widget.recipe['ingredients'][i + 1]['name']}',
                                    style: const TextStyle(
                                      color: Color.fromARGB(255, 255, 255, 255),
                                      fontSize: 14,
                                      fontFamily: 'Poppins',
              ...
              FutureBuilder<Map<String, List<String>>>(
                ...
                builder: (context, snapshot) {
                  if (snapshot.connectionState == ConnectionState.waiting) {
                    ...
                    List<Map<String, dynamic>> uniqueIngredients = ingredients
                          ...
                          if (selectedIngredient != null)
                            Padding(
                              ...
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.center,
                                children: [
                                  ...selectedSubstitute?.map((item) => Padding(
                                            padding: const EdgeInsets.only(
                                                left: 45.0,
                                                right: 15,
                                                bottom: 5),
