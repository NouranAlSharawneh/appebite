  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      child: Column(
        ...
        children: [
          Container(
            margin: EdgeInsets.fromLTRB(0 * widget.fem, 0 * widget.fem, 4 * widget.fem, 15 * widget.fem),
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Row(
                  ...
                  children: [
                    Container(
                      margin: EdgeInsets.fromLTRB(0 * widget.fem, 0 * widget.fem, 250 * widget.fem, 0 * widget.fem),
                      child: Text(
                        'Steps ',
                    ...
                    return Dismissible(
                      ...
                      child: SizedBox(
                        ...
                        child: Row(
                          ...
                          children: [
                            Container(
                              margin: EdgeInsets.fromLTRB(0 * widget.fem, 0 * widget.fem, 8 * widget.fem, 0 * widget.fem),
                              width: 24 * widget.fem,
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.center,
                                children: [
                                  Container(
                                    margin: EdgeInsets.fromLTRB(0 * widget.fem, 0 * widget.fem, 0 * widget.fem, 10 * widget.fem),
                                    width: double.infinity,
                                    height: 24 * widget.fem,
