...
class PlansInfo extends StatefulWidget {
  final Map<String, dynamic> recipe;


  const PlansInfo({Key? key, required this.recipe}) : super(key: key);

  @override
  _PlansInfoState createState() => _PlansInfoState();
}
